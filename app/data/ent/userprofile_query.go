...
func (upq *UserProfileQuery) FirstIDX(ctx context.Context) string {
...
func (upq *UserProfileQuery) OnlyIDX(ctx context.Context) string {
...
func (upq *UserProfileQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (upq *UserProfileQuery) IDsX(ctx context.Context) []string {
	ids, err := upq.IDs(ctx)
	if err != nil {
		panic(err)
	}
