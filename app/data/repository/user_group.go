...
import (
	...
	groupEnt "ncobase/app/data/ent/group"
	userEnt "ncobase/app/data/ent/user"
	userGroupEnt "ncobase/app/data/ent/usergroup"
...
func NewUserGroup(d *data.Data) UserGroup {
	ec := d.GetEntClient()
	rc := d.GetRedis()
	return &userGroupRepo{ec, rc, cache.NewCache[ent.UserGroup](rc, "nb_user_group")}
}
