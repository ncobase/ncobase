...
func (_q *UserRoleQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserRoleQuery) FirstIDX(ctx context.Context) string {
...
func (_q *UserRoleQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *UserRoleQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *UserRoleQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *UserRoleQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
