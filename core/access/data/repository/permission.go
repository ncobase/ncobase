...
func (r *permissionRepository) Create(ctx context.Context, body *structs.CreatePermissionBody) (*ent.Permission, error) {
	...
	if err != nil {
		log.Errorf(ctx, "permissionRepo.Create error: %v", err)
		return nil, err
	}
...
func (r *permissionRepository) GetByName(ctx context.Context, name string) (*ent.Permission, error) {
	...
	if err != nil {
		log.Errorf(ctx, "permissionRepo.GetByName error: %v", err)
		return nil, err
	}
	...
	if err != nil {
		log.Errorf(ctx, "permissionRepo.GetByName cache error: %v", err)
	}
...
func (r *permissionRepository) GetByID(ctx context.Context, id string) (*ent.Permission, error) {
	...
	if err != nil {
		log.Errorf(ctx, "permissionRepo.GetByID error: %v", err)
		return nil, err
	}
	...
	err = r.c.Set(ctx, cacheKey, row)
	if err != nil {
		log.Errorf(ctx, "permissionRepo.GetByID cache error: %v", err)
	}
...
func (r *permissionRepository) GetByActionAndSubject(ctx context.Context, action, subject string) (*ent.Permission, error) {
	...
	if err != nil {
		log.Errorf(ctx, "permissionRepo.GetByActionAndSubject error: %v", err)
		return nil, err
	}
	...
	err = r.c.Set(ctx, cacheKey, row)
	if err != nil {
		log.Errorf(ctx, "permissionRepo.GetByActionAndSubject cache error: %v", err)
	}
...
func (r *permissionRepository) Update(ctx context.Context, id string, updates types.JSON) (*ent.Permission, error) {
	...
	row, err := builder.Save(ctx)
	if err != nil {
		log.Errorf(ctx, "permissionRepo.Update error: %v", err)
		return nil, err
	}
	...
	if err != nil {
		log.Errorf(ctx, "permissionRepo.Update cache error: %v", err)
	}
...
func (r *permissionRepository) Delete(ctx context.Context, id string) error {
	...
	if _, err = builder.Where(permissionEnt.IDEQ(permission.ID)).Exec(ctx); err != nil {
		log.Errorf(ctx, "permissionRepo.Delete error: %v", err)
		return err
	}
	...
	err = r.c.Delete(ctx, cacheKey)
	if err != nil {
		log.Errorf(ctx, "permissionRepo.Delete cache error: %v", err)
	}
