...
import (
	...
	"ncobase/core/group/data/ent/usergroup"
...
func (ugq *UserGroupQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (ugq *UserGroupQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usergroup.Table, usergroup.Columns, sqlgraph.NewFieldSpec(usergroup.FieldID, field.TypeString))
	_spec.From = ugq.sql
