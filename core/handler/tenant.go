...
func (h *Handler) AccountTenantHandler(c *gin.Context) {
	result, err := h.svc.AccountTenantService(c.Request.Context())
	if err != nil {
...
func (h *Handler) AccountTenantsHandler(c *gin.Context) {
	result, err := h.svc.AccountTenantsService(c.Request.Context())
	if err != nil {
		resp.Fail(c.Writer, resp.BadRequest(err.Error()))
		return
	}
...
func (h *Handler) CreateTenantHandler(c *gin.Context) {
	...
	result, err := h.svc.CreateTenantService(c.Request.Context(), body)
	if err != nil {
...
func (h *Handler) UserTenantHandler(c *gin.Context) {
	result, err := h.svc.UserOwnTenantService(c.Request.Context(), c.Param("username"))
	if err != nil {
		resp.Fail(c.Writer, resp.BadRequest(err.Error()))
		return
	}
...
func (h *Handler) UpdateTenantHandler(c *gin.Context) {
	...
	result, err := h.svc.UpdateTenantService(c.Request.Context(), body)
	if err != nil {
		resp.Fail(c.Writer, resp.BadRequest(err.Error()))
		return
	}
...
func (h *Handler) GetTenantHandler(c *gin.Context) {
	result, err := h.svc.GetTenantService(c.Request.Context(), c.Param("slug"))
	if err != nil {
		resp.Fail(c.Writer, resp.BadRequest(err.Error()))
		return
	}
...
func (h *Handler) DeleteTenantHandler(c *gin.Context) {
	result, err := h.svc.DeleteTenantService(c.Request.Context(), c.Param("slug"))
	if err != nil {
		resp.Fail(c.Writer, resp.BadRequest(err.Error()))
		return
	}
...
func (h *Handler) ListTenantHandler(c *gin.Context) {
	...
	result, err := h.svc.ListTenantsService(c.Request.Context(), params)
	if err != nil {
		resp.Fail(c.Writer, resp.BadRequest(err.Error()))
		return
	}
