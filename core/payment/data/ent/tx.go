...
func (tx *Tx) init() {
	...
	tx.PaymentLog = NewPaymentLogClient(tx.config)
	tx.PaymentOrder = NewPaymentOrderClient(tx.config)
	tx.PaymentProduct = NewPaymentProductClient(tx.config)
	tx.PaymentSubscription = NewPaymentSubscriptionClient(tx.config)
}
...
// applies a query, for example: PaymentChannel.QueryXXX(), the query will be executed
