...
const (
	// Label holds the string label denoting the spacedictionary type in the database.
	Label = "space_dictionary"
...
// OrderOption defines the ordering options for the SpaceDictionary queries.
