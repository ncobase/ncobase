...
// SpaceBillingBody represents billing information for a space
type SpaceBillingBody struct {
...
// CreateSpaceBillingBody represents the body for creating space billing
type CreateSpaceBillingBody struct {
	SpaceBillingBody
}

// UpdateSpaceBillingBody represents the body for updating space billing
type UpdateSpaceBillingBody struct {
	ID string `json:"id,omitempty"`
	SpaceBillingBody
}

// ReadSpaceBilling represents the output schema for retrieving space billing
type ReadSpaceBilling struct {
	ID            string        `json:"id"`
...
// ListSpaceBillingParams represents the query parameters for listing space billing
type ListSpaceBillingParams struct {
...
// BillingSummary represents billing summary for a space
