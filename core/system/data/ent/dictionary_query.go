...
func (dq *DictionaryQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (dq *DictionaryQuery) FirstIDX(ctx context.Context) string {
...
func (dq *DictionaryQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (dq *DictionaryQuery) OnlyIDX(ctx context.Context) string {
...
func (dq *DictionaryQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (dq *DictionaryQuery) IDsX(ctx context.Context) []string {
	ids, err := dq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (dq *DictionaryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(dictionary.Table, dictionary.Columns, sqlgraph.NewFieldSpec(dictionary.FieldID, field.TypeString))
	_spec.From = dq.sql
