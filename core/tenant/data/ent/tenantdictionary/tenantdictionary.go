...
const (
	// Label holds the string label denoting the tenantdictionary type in the database.
	Label = "tenant_dictionary"
	...
	// Table holds the table name of the tenantdictionary in the database.
	Table = "ncse_sys_tenant_dictionary"
)

// Columns holds all SQL columns for tenantdictionary fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldDictionaryID,
...
// OrderOption defines the ordering options for the TenantDictionary queries.
