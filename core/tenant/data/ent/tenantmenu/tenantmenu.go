...
const (
	// Label holds the string label denoting the tenantmenu type in the database.
	Label = "tenant_menu"
	...
	// Table holds the table name of the tenantmenu in the database.
	Table = "ncse_sys_tenant_menu"
)

// Columns holds all SQL columns for tenantmenu fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldMenuID,
...
// OrderOption defines the ordering options for the TenantMenu queries.
