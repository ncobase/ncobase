...
func (rq *RuleQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (rq *RuleQuery) FirstIDX(ctx context.Context) string {
...
func (rq *RuleQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (rq *RuleQuery) OnlyIDX(ctx context.Context) string {
...
func (rq *RuleQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (rq *RuleQuery) IDsX(ctx context.Context) []string {
	ids, err := rq.IDs(ctx)
	if err != nil {
		panic(err)
	}
