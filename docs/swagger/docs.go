...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_ncobase_ncore_pkg_resp.Exception"
                        }
                    }
                }
            },
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_ncobase_ncore_pkg_types.JSON"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "github_com_ncobase_ncore_pkg_resp.Exception": {
            "type": "object",
            "properties": {
                "code": {
        ...
        "github_com_ncobase_ncore_pkg_types.JSON": {
            "type": "object",
            "additionalProperties": {}
        },
