...
// @Router /system/dictionarys [post]
// @Security Bearer
...
// @Success 200 {object} structs.ReadDictionary "success"
// @Failure 400 {object} resp.Exception "bad request"
// @Router /system/dictionarys/{slug} [get]
// @Security Bearer
...
// @Failure 400 {object} resp.Exception "bad request"
// @Router /system/dictionarys/{slug} [delete]
// @Security Bearer
