...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.UserTenantRole.Intercept(interceptors...)
}
...
type (
	hooks struct {
		Tenant, UserTenant, UserTenantRole []ent.Hook
	}
	inters struct {
		Tenant, UserTenant, UserTenantRole []ent.Interceptor
	}
)
