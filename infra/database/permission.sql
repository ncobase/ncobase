...
VALUES
  ...
  (nanoid(), 'change_password', 'PUT', '/v1/account/password', 'Change account password', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'read_account_tenant', 'GET', '/v1/account/tenant', 'Read account tenant information', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
VALUES
  ...
  (nanoid(), 'read_asset', 'GET', '/v1/assets/{slug}', 'Read a specific asset', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'update_asset', 'PUT', '/v1/assets/{slug}', 'Update a specific asset', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
VALUES
  ...
  (nanoid(), 'read_menu', 'GET', '/v1/menus/{slug}', 'Read a specific menu', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'update_menu', 'PUT', '/v1/menus/{slug}', 'Update a specific menu', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
VALUES
  ...
  (nanoid(), 'read_permission', 'GET', '/v1/permissions/{slug}', 'Read a specific permission', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'update_permission', 'PUT', '/v1/permissions/{slug}', 'Update a specific permission', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
VALUES
  ...
  (nanoid(), 'read_policy', 'GET', '/v1/policies/{id}', 'Read a specific policy', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'update_policy', 'PUT', '/v1/policies/{id}', 'Update a specific policy', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
VALUES
  ...
  (nanoid(), 'read_role', 'GET', '/v1/roles/{slug}', 'Read a specific role', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'update_role', 'PUT', '/v1/roles/{slug}', 'Update a specific role', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'delete_role', 'DELETE', '/v1/roles/{slug}', 'Delete a specific role', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
VALUES
  ...
  (nanoid(), 'read_taxonomy', 'GET', '/v1/taxonomies/{slug}', 'Read a specific taxonomy', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'update_taxonomy', 'PUT', '/v1/taxonomies/{slug}', 'Update a specific taxonomy', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
VALUES
  ...
  (nanoid(), 'read_tenant', 'GET', '/v1/tenants/{slug}', 'Read a specific tenant', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'update_tenant', 'PUT', '/v1/tenants/{slug}', 'Update a specific tenant', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'delete_tenant', 'DELETE', '/v1/tenants/{slug}', 'Delete a specific tenant', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_tenant_assets', 'POST', '/v1/tenants/{slug}/assets', 'Manage assets for a specific tenant', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_tenant_groups', 'POST', '/v1/tenants/{slug}/groups', 'Manage groups for a specific tenant', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_tenant_menu', 'POST', '/v1/tenants/{slug}/menu', 'Manage menu for a specific tenant', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_tenant_roles', 'POST', '/v1/tenants/{slug}/roles', 'Manage roles for a specific tenant', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_tenant_setting', 'POST', '/v1/tenants/{slug}/setting', 'Manage setting for a specific tenant', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_tenant_settings', 'POST', '/v1/tenants/{slug}/settings', 'Manage settings for a specific tenant', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
VALUES
  ...
  (nanoid(), 'read_topic', 'GET', '/v1/topics/{slug}', 'Read a specific topic', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'update_topic', 'PUT', '/v1/topics/{slug}', 'Update a specific topic', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
--   (nanoid(), 'write_all', 'POST', '*', 'Write access to all resources', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
--   (nanoid(), 'update_all', 'PUT', '*', 'Update access to all resources', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
...
VALUES
  ...
  (nanoid(), 'manage_authorization', '*', '/v1/authorize*', 'Full access to authorization-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_captcha', '*', '/v1/captcha*', 'Full access to captcha-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_menus', '*', '/v1/menus*', 'Full access to menu-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_permissions', '*', '/v1/permissions*', 'Full access to permission-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_policies', '*', '/v1/policies*', 'Full access to policy-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_roles', '*', '/v1/roles*', 'Full access to role-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_taxonomies', '*', '/v1/taxonomies*', 'Full access to taxonomy-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_tenants', '*', '/v1/tenants*', 'Full access to tenant-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_topics', '*', '/v1/topics*', 'Full access to topic-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000),
  (nanoid(), 'manage_users', '*', '/v1/users*', 'Full access to user-related endpoints', false, false, '{}', null, null, EXTRACT(EPOCH FROM now()) * 1000, EXTRACT(EPOCH FROM now()) * 1000);
