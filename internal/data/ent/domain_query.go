...
func (dq *DomainQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (dq *DomainQuery) FirstIDX(ctx context.Context) string {
...
func (dq *DomainQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (dq *DomainQuery) OnlyIDX(ctx context.Context) string {
...
func (dq *DomainQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (dq *DomainQuery) IDsX(ctx context.Context) []string {
	ids, err := dq.IDs(ctx)
	if err != nil {
		panic(err)
	}
