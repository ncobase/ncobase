...
func (tq *TaxonomyQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (tq *TaxonomyQuery) FirstIDX(ctx context.Context) string {
...
func (tq *TaxonomyQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (tq *TaxonomyQuery) OnlyIDX(ctx context.Context) string {
...
func (tq *TaxonomyQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (tq *TaxonomyQuery) IDsX(ctx context.Context) []string {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
