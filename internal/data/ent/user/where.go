...
// IsCertifiedIsNil applies the IsNil predicate on the "is_certified" field.
func IsCertifiedIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldIsCertified))
}

// IsCertifiedNotNil applies the NotNil predicate on the "is_certified" field.
func IsCertifiedNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldIsCertified))
}
...
func ExtrasIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldExtras))
}

// ExtrasNotNil applies the NotNil predicate on the "extras" field.
func ExtrasNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldExtras))
}
