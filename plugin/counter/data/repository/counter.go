...
func (r *counterRepository) Create(ctx context.Context, body *structs.CreateCounterBody) (*ent.Counter, error) {
	...
	if err != nil {
		log.Errorf(context.Background(), "counterRepo.Create error: %v\n", err)
		return nil, err
	}

	// Create the counter in Meilisearch index
	if err = r.ms.IndexDocuments("counters", row); err != nil {
		log.Errorf(context.Background(), "counterRepo.Create error creating Meilisearch index: %v\n", err)
		// return nil, err
	}
...
func (r *counterRepository) GetByID(ctx context.Context, id string) (*ent.Counter, error) {
	...
	if err != nil {
		log.Errorf(context.Background(), "counterRepo.GetByID error: %v\n", err)
		return nil, err
	}
	...
	if err != nil {
		log.Errorf(context.Background(), "counterRepo.GetByID cache error: %v\n", err)
	}
...
func (r *counterRepository) Update(ctx context.Context, slug string, updates types.JSON) (*ent.Counter, error) {
	...
	row, err := builder.Save(ctx)
	if err != nil {
		log.Errorf(context.Background(), "counterRepo.Update error: %v\n", err)
		return nil, err
	}
	...
	if err != nil {
		log.Errorf(context.Background(), "counterRepo.Update cache error: %v\n", err)
	}

	// Update the counter in Meilisearch index
	if err = r.ms.DeleteDocuments("counters", slug); err != nil {
		log.Errorf(context.Background(), "counterRepo.Update error deleting Meilisearch index: %v\n", err)
		// return nil, err
	}
	if err = r.ms.IndexDocuments("counters", row); err != nil {
		log.Errorf(context.Background(), "counterRepo.Update error updating Meilisearch index: %v\n", err)
		// return nil, err
	}
...
func (r *counterRepository) List(ctx context.Context, params *structs.ListCounterParams) ([]*ent.Counter, error) {
	...
	if err != nil {
		log.Errorf(context.Background(), "counterRepo.List error: %v\n", err)
		return nil, err
	}
...
func (r *counterRepository) Delete(ctx context.Context, slug string) error {
	...
	if _, err = builder.Where(counterEnt.IDEQ(counter.ID)).Exec(ctx); err != nil {
		log.Errorf(context.Background(), "counterRepo.Delete error: %v\n", err)
		return err
	}
	...
	if err != nil {
		log.Errorf(context.Background(), "counterRepo.Delete cache error: %v\n", err)
	}

	// delete from Meilisearch index
	if err = r.ms.DeleteDocuments("counters", counter.ID); err != nil {
		log.Errorf(context.Background(), "counterRepo.Delete index error: %v\n", err)
		// return nil, err
	}
