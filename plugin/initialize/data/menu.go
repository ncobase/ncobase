...
var SystemDefaultMenus = struct {
	...
	Headers: []structs.MenuBody{
		...
		},
		{
			...
			Path:     "/system/orgs",
			Perms:    "read:system",
			Order:    convert.ToPointer(600),
			Hidden:   convert.ToPointer(false),
			Disabled: convert.ToPointer(false),
		},
		{
			Name:     "NCore",
			Label:    "ncore.navigation",
			Slug:     "ncore",
			Type:     "header",
			Path:     "/ncore",
			Icon:     "IconPuzzle",
			Perms:    "manage:ncore",
			Order:    convert.ToPointer(500),
			Hidden:   convert.ToPointer(false),
			Disabled: convert.ToPointer(false),
		},
		{
	...
	Sidebars: []structs.MenuBody{
		...
		{
			Name:     "Dictionary",
			Label:    "system.dictionaries.navigation",
			Slug:     "system-dictionaries",
			Type:     "sidebar",
			Path:     "/system/dictionaries",
			Icon:     "IconVocabulary",
			Perms:    "read:dictionaries",
		...
		{
			Name:     "Basic",
			Label:    "system.basics.navigation",
			Slug:     "system-basics",
			Type:     "sidebar",
			Path:     "/system/basics",
			Icon:     "IconSettings2",
		...
		{
			Name:     "Roles",
			Label:    "account.roles.navigation",
			Slug:     "account-roles",
			Type:     "sidebar",
			Path:     "/account/roles",
			Icon:     "IconUsersGroup",
		...
		{
			Name:     "Permissions",
			Label:    "account.permissions.navigation",
		...
		{
			Name:     "Policies",
			Label:    "account.policies.navigation",
		...
		{
			Name:     "Activities",
			Label:    "account.activities.navigation",
			Slug:     "account-activities",
			Type:     "sidebar",
		...
		{
			Name:     "Topic",
			Label:    "content.topics.navigation",
			Slug:     "content-topics",
			Type:     "sidebar",
			Path:     "/content/topics",
			Icon:     "IconArticle",
		...
		{
			Name:     "Comment",
			Label:    "content.comments.navigation",
			Slug:     "content-comments",
			Type:     "sidebar",
		...
		{
			Name:     "Approval",
			Label:    "content.approvals.navigation",
			Type:     "sidebar",
			Path:     "/content/approvals",
			Icon:     "IconChecklist",
			Perms:    "manage:approvals",
			Order:    convert.ToPointer(95),
			Hidden:   convert.ToPointer(false),
			Disabled: convert.ToPointer(false),
			ParentID: "content",
	...
	Submenus: []structs.MenuBody{
		...
		{
			Name:     "System",
			Label:    "system.basics.setting.navigation",
...
var MenuPermissionMapping = map[string]string{
	...
	// Content module sidebars
	"content-topics":    "read:content",
	"content-comments":  "read:comments",
	...
	"submenu-users-list":     "read:users",
	"submenu-users-create":   "create:users",
}
