...
func (_q *LogsQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *LogsQuery) FirstIDX(ctx context.Context) string {
...
func (_q *LogsQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *LogsQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *LogsQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *LogsQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LogsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(logs.Table, logs.Columns, sqlgraph.NewFieldSpec(logs.FieldID, field.TypeString))
	_spec.From = _q.sql
