...
// RoleServiceInterface defines role service interface for proxy plugin
...
// RolePermissionServiceInterface defines role permission service interface for proxy plugin
...
// UserRoleServiceInterface defines user role service interface for proxy plugin
