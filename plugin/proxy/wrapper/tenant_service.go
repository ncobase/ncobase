...
// TenantServiceInterface defines tenant service interface for proxy plugin
type TenantServiceInterface interface {
	...
	Update(ctx context.Context, body *tenantStructs.UpdateTenantBody) (*tenantStructs.ReadTenant, error)
...
// UpdateTenant updates tenant with fallback
func (w *TenantServiceWrapper) UpdateTenant(ctx context.Context, body *tenantStructs.UpdateTenantBody) (*tenantStructs.ReadTenant, error) {
	if w.tenantService != nil {
		return w.tenantService.Update(ctx, body)
	}
	return nil, fmt.Errorf("tenant service not available")
}
