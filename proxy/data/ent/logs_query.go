...
func (lq *LogsQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (lq *LogsQuery) FirstIDX(ctx context.Context) string {
...
func (lq *LogsQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (lq *LogsQuery) OnlyIDX(ctx context.Context) string {
...
func (lq *LogsQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (lq *LogsQuery) IDsX(ctx context.Context) []string {
	ids, err := lq.IDs(ctx)
	if err != nil {
		panic(err)
	}
